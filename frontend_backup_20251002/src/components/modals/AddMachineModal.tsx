...
const AddMachineModal: React.FC<AddMachineModalProps> = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-dark-800 rounded-xl border border-dark-700 w-full max-w-lg overflow-hidden">
        <div className="p-4 border-b border-dark-700 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-dark-100">Add New Machine</h2>
          <button 
            onClick={handleClose} 
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <button
              type="submit"
              className="px-4 py-2 text-sm bg-accent-green-500 bg-opacity-20 text-accent-green-400 rounded-lg hover:bg-opacity-30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={isSubmitting}
            >
